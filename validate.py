...
def main():
    ...
    # load configuration
    with open('/home/conrad/PycharmProjects/seg LIDC-IDRI/model_outputs/{}/config.yml'.format(NAME), 'r') as f:
        config = yaml.load(f)
    ...
    # Data loading code
    IMAGE_DIR = '/home/conrad/PycharmProjects/LIDC-IDRI-Preprocessing/data/Image/'
    MASK_DIR = '/home/conrad/PycharmProjects/LIDC-IDRI-Preprocessing/data/Mask/'
    #Meta Information
    ...
    OUTPUT_MASK_DIR = '/media/conrad/90FA710BFA70EF3A/Conrad/Download/datasets/seg_pre/{}'.format(NAME)
    ...
    ## Load Clean related ####
    ##########################
    CLEAN_DIR_IMG ='/home/conrad/PycharmProjects/LIDC-IDRI-Preprocessing/data/Clean/Image/'
    CLEAN_DIR_MASK ='/home/conrad/PycharmProjects/LIDC-IDRI-Preprocessing/data/Clean/Mask/'
    ...
    CLEAN_OUTPUT_MASK_DIR = '/media/conrad/90FA710BFA70EF3A/Conrad/Download/datasets/clean_seg_pre/{}'.format(CLEAN_NAME)
