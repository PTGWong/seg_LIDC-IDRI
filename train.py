...
def main():
    ...
    IMAGE_DIR = '/media/conrad/90FA710BFA70EF3A/Conrad/Download/datasets/seg_image/'                                       #
    MASK_DIR = '/media/conrad/90FA710BFA70EF3A/Conrad/Download/datasets/seg_mask/'                                         #
    #Meta Information                                                          #
    meta = pd.read_csv('/media/conrad/90FA710BFA70EF3A/Conrad/Download/datasets/pre/data/Clean/Meta/clean_meta.csv')                    #
    ############################################################################
